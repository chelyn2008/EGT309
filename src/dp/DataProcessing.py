...
# exporting datasets
X_test.to_csv('/mnt/pv/X_test.csv')
X_test_1.to_csv('/mnt/pv/X_test_1.csv')
np.save('/mnt/pv/X_test_scaled.npy', X_test_scaled)
np.save('/mnt/pv/y_train.npy', y_train)
X_train_1.to_csv('/mnt/pv/X_train_1.csv')
np.save('/mnt/pv/X_train_scaled.npy', X_val_scaled)
X_val.to_csv('/mnt/pv/X_val.csv')
X_val_1.to_csv('/mnt/pv/X_val_1.csv')
np.save('/mnt/pv/X_val_scaled.npy', X_val_scaled)
np.save('/mnt/pv/y_val.npy', y_val)
